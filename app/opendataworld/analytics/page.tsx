      ...
      <section className="mx-auto max-w-7xl px-6 py-20 sm:px-10 lg:px-16">
        ...
        <div className="mt-12 grid gap-5 md:grid-cols-2 lg:grid-cols-3">
          {analyticsPanels.map((panel) => (
            <div key={panel} className="rounded-3xl border border-white/10 bg-white/[0.04] p-6">
              <h2 className="text-2xl font-bold">{panel}</h2>
              <p className="mt-3 text-slate-400">Operational visibility for trusted open data systems.</p>
            </div>
          ))}
        </div>
      </section>
